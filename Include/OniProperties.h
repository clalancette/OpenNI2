...
enum
{
	...
	DEVICE_PROPERTY_PLAYBACK_REPEAT_ENABLED		= 101, // bool
};
...
enum
{
	...
	STREAM_PROPERTY_MIRRORING			= 7, // bool

	STREAM_PROPERTY_NUMBER_OF_FRAMES		= 8, // int

	// Camera
	STREAM_PROPERTY_AUTO_WHITE_BALANCE		= 100, // bool
	STREAM_PROPERTY_AUTO_EXPOSURE			= 101, // bool
