...
// Code
//---------------------------------------------------------------------------
static XnStatus AccessFlagsToWin32MapFlags(uint32_t nAccessFlags, DWORD* pFlags)
{
	DWORD result = 0;
...
static XnStatus AccessFlagsToWin32ViewFlags(uint32_t nAccessFlags, DWORD* pFlags)
{
	DWORD result = 0;
