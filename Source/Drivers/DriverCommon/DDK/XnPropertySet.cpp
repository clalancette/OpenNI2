...
XnStatus XnPropertySetEnumeratorGetCurrentPropertyInfo(const XnPropertySetEnumerator* pEnumerator, XnPropertyType* pnType, const char** pstrModule, const char** pstrProp)
{
	XN_VALIDATE_INPUT_PTR(pEnumerator);
