...
_XN_DEPRECATED_TYPE(int8_t, XN_INT8)
_XN_DEPRECATED_TYPE(uint8_t, XN_UINT8)
_XN_DEPRECATED_TYPE(int16_t, XN_INT16)
_XN_DEPRECATED_TYPE(uint16_t, XN_UINT16)
_XN_DEPRECATED_TYPE(int32_t, XN_INT32)
_XN_DEPRECATED_TYPE(uint32_t, XN_UINT32)
_XN_DEPRECATED_TYPE(int64_t, XN_INT64)
_XN_DEPRECATED_TYPE(uint64_t, XN_UINT64)
_XN_DEPRECATED_TYPE(float, XN_FLOAT)
_XN_DEPRECATED_TYPE(double, XN_DOUBLE)
...
XN_API_DEPRECATED("Please use OniDepthPixel instead") typedef uint16_t XN_DEPTH_TYPE;
